...
| `camera.sh` | Canon DSLR (1300D/2000D) parameter control via gphoto2: relay power-up → USB detect → get/set with verify; focus-square selection (3×3 grid, resolution-aware); interactive menu + CLI | manual / scripted |
